...
class OnlineReaderSystem {
	...
	private HashMap<Integer, LibraryUser> activeUsers;

	public OnlineReaderSystem() {
		userManager = new LibraryUserManager();
		library = new Library();
		display = new Display();
		activeUsers = new HashMap<Integer,LibraryUser>();
	}
	...
	public LibraryUserManager getUserManager() {
		return userManager;
	}

	public Display getDisplay(LibraryUser user) {
	...
	public Book getActiveBook(LibraryUser user) {
		return activeUsers.get(user.getId()).
				getUserLib().find(user.getActiveBookId());
	}

	public void setActiveBook(LibraryUser user, Book book) {
	...
	public boolean addActiveUser(LibraryUser user) {
		if (activeUsers.get(user.getId()) == null)
			activeUsers.put(user.getId(), user);
	...
	public boolean removeActiveUser(LibraryUser user) {
		if (activeUsers.get(user.getId())==null) {
...
class LibraryUserManager {
	...
	public Boolean addUser(int id, String details,String name) {
		...
		LibraryUser user = new LibraryUser(id, details,name);
		users.put(id, user);
		return true;
	}
	...
	public boolean remove(LibraryUser u) {
...
class Display {
	...
	public void setActiveUser(LibraryUser user) {
		activeUser = user;
	...
	public void displayBook(LibraryUser user) {
...
class LibraryUser {
	...
	public LibraryUser(int id, String details,String name) {
		this.userId = id;
		this.details = details;
		this.name = name;
...
public class DemoOnlineBookReaderSystem {
	...
	public static void main(String[] args) {
		...
		LibraryUser user1 = new LibraryUser(1," ","Ram");
		LibraryUser user2 = new LibraryUser(2," ","Gopal");
